...
enum SettingsPane: String, CaseIterable, Identifiable, Hashable, Sendable {
    ...
    var systemImage: String {
        ...
        case .tracking: "scope"
        case .pcc: "icloud.and.arrow.down.fill"
    ...
    var searchTitles: [String] {
        ...
        case .pcc:
            [
                "PCC judge", "PCC second opinion", "Silent PCC judge", "Audit confident verdicts",
                "Smoke test", "Status", "Fine-tuning exports", "Export judgments",
                "Learned corrections", "Analyze judge records", "Apply", "Remove all corrections"
            ]
        case .tools:
            [
    ...
    static let sidebarGroups: [SettingsSidebarGroup] = [
        ...
        SettingsSidebarGroup(
            id: "recognition",
            title: "Recognition",
            panes: [.overlay, .detection, .tracking, .pcc]
        ),
